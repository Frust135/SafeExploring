...
if __name__ == "__main__":    
    ...
    luna_lander_button = tk.Button(options_frame, text="Seleccionar", command=luna_lander_option)
    luna_lander_controlled_checkbox = tk.Checkbutton(options_frame, text="Controlado")
